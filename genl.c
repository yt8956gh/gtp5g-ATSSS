...
static const struct nla_policy gtp5g_genl_pdr_policy[GTP5G_PDR_ATTR_MAX + 1] = {
    ...
    [GTP5G_PDR_FAR_ID_3GPP]                     = { .type = NLA_U32, },
    [GTP5G_PDR_FAR_ID_NON3GPP]                  = { .type = NLA_U32, },
    [GTP5G_PDR_QER_ID]                          = { .type = NLA_U32, },
    [GTP5G_UE_MPTCP_3GPP_ADDR_IPV4]             = { .type = NLA_U32, },
    [GTP5G_UE_MPTCP_NON3GPP_ADDR_IPV4]          = { .type = NLA_U32, },
};
